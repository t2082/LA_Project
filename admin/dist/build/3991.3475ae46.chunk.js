"use strict";(self.webpackChunkadmin=self.webpackChunkadmin||[]).push([[3991],{94061:(j,m,t)=>{t.d(m,{a:()=>g});var i=t(63891),d=t(28672),a=t(5146);const o={color:!0,cursor:!0,height:!0,width:!0},g=i.Ay.div.withConfig({shouldForwardProp:(e,s)=>!o[e]&&s(e)})`
  // Font
...
`},30893:(j,m,t)=>{t.d(m,{o:()=>I});var i=t(63891);const d="alpha",a="beta",o="delta",g="epsilon",e="omega",s="pi",f="sigma",P=[d,a,o,g,e,s,f],y=({ellipsis:u=!1})=>u&&`
  ...
  `,W=({variant:u=e,theme:n})=>{switch(u){case d:return`
      ...
      `;default:return`
        font-size: ${n.fontSizes[2]};
      `}};var $=t(5146);const A={fontSize:!0,fontWeight:!0},I=i.Ay.span.withConfig({shouldForwardProp:(u,n)=>!A[u]&&n(u)})`
  ${W}
  ${y}

  // These properties need to come after {variantStyle}, because they might
  // overwrite a variant attribute
  font-weight: ${({theme:u,fontWeight:n})=>(0,$.K)(u.fontWeights,n,void 0)};
  font-size: ${({theme:u,fontSize:n})=>(0,$.K)(u.fontSizes,n,void 0)};
  line-height: ${({theme:u,lineHeight:n})=>(0,$.K)(u.lineHeights,n,n)};
